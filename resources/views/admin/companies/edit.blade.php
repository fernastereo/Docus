    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('companies.update', $company->id) }}" aria-label="{{ __('Register') }}">
                        @method('put')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="prefixcdocument" type="text" class="form-control{{ $errors->has('prefixcdocument') ? ' is-invalid' : '' }}" name="prefixcdocument" value="{{ $company->prefixcdocument }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="startdate" type="date" class="form-control{{ $errors->has('startdate') ? ' is-invalid' : '' }}" name="startdate" value="{{ date('d-m-Y', strtotime($company->startdate)) }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="bucket" type="text" class="form-control{{ $errors->has('bucket') ? ' is-invalid' : '' }}" name="bucket" value="{{ $company->bucket }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="consecutive" type="text" class="form-control{{ $errors->has('consecutive') ? ' is-invalid' : '' }}" name="consecutive" value="{{ $company->consecutive }}" required autofocus>
